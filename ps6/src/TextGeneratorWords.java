...
public class TextGeneratorWords {
    ...
    public static String[] buildModel(int order, String fileName, MarkovModel model) {
        ...
        return model.initializeTextWords(text.toString(), order);
    }
    ...
    public static void generateText(MarkovModel model, String[] seedText, int order, int length) {
        ...
        System.arraycopy(seedText, 0, words, 0, order);
        ...
        while (i < length) {
            ...
            stringToAppend = model.nextWord(String.join(", ", Arrays.copyOfRange(words, i-order, i)));
